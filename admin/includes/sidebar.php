<aside>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="add-state.php">Add District</a></li>
                        <li><a href="manage-state.php">Mange District</a></li>
 ...
 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="manage-city.php">Mange City</a></li>
                       
                    </ul>
                </li>

                <li>
                    <a href="manage-donor-details.php">
        ...
        <li>
               ...
               <li class="sub-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="report-donated-food.php">Report of donated Food</a></li>
                        <li><a href="report-food-donor.php">Report of Reg Food Donor</a></li>
                    </ul>
                </li>
               <!-- <li>
                    <a href="search.php">
                        <i class="fa fa-search"></i>
                        <span>Search Listed Food </span>
                    </a>
                </li> -->
