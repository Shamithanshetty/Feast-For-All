...
<!DOCTYPE html>
<head>
<title>Feast For All|| New Food Requests</title>
...
tblfoodrequests
 join tblfood  on tblfood.ID=tblfoodrequests.foodId where tblfood.DonorID='$donarid' and (tblfoodrequests.status is null || tblfoodrequests.status='')");
$cnt=1;
